...
// ========================================================
// DOMContentLoaded - Inicialização de todos os componentes
// ========================================================
document.addEventListener('DOMContentLoaded', () => {
  // Serviços
  servCards = Array.from(document.querySelectorAll('.services-carousel .service-card'));
  showServCard(servIndex);
  ...
  // Carrossel de acomodações (imagens)
  slides = Array.from(document.querySelectorAll('.acomodacoes-slide'));
  showAcomSlide(acomIndex);
  startAcomTimer();

  // Botões do carrossel de acomodações
...
(function(a,b,c,d){
  try{
    ...
    f.defer=true;
    a.neuroleadId})(window,document,"https://cdn.leadster.com.br/neurolead/neurolead.min.js","n1KtVCoHGEyvTCCNhhJf9P6p3")